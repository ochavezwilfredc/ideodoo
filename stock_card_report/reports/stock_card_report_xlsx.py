...
class ReportStockCardReportXlsx(models.AbstractModel):
    ...
    def _get_ws_params(self, wb, data, product):
        ...
        initial_template = {
            "1_ref": {
                "data": {"value": "Inicial", "format": self.format_tcell_center},
                "colspan": 4,
            },
            "2_balance": {
                "data": {
        ...
        ws_params = {
            ...
            "title": "Stock Producto - {}".format(product.name),
